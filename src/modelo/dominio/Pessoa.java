...
public class Pessoa implements Serializable{
	...
	@Size(min=8,max=70,message="Descri��o deve ter no m�ximo {max} caracteres e no minimo" + " {min} caracteres. Voc� digitou: " + "${validatedValue}")
	...
	public Pessoa(Long id, String nomeCompleto, int cpf, int rg, Date dataDeNascimento, Sexo sexo, 
			String nomeDaMae, String nomeDoPai, EstadoCivil estadoCivil, TipoSanguineo tipoSanguineo, GrauDeEscolaridade grauDeEscolaridade, String email, int telefone, Endereco endereco){
	...
	public String toString() {
		return "Pessoa [id=" + id + ", nomeCompleto=" + nomeCompleto + ", cpf="
				+ cpf + ", rg=" + rg + ", dataDeNascimento=" + dataDeNascimento
				+ ", sexo=" + sexo + ", nomeDaMae=" + nomeDaMae
				+ ", nomeDoPai=" + nomeDoPai + ", estadoCivil=" + estadoCivil
				+ ", tipoSanguineo=" + tipoSanguineo + ", grauDeEscolaridade="
				+ grauDeEscolaridade + ", email=" + email + ", telefone="
